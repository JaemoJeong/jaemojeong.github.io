...
page data: a guitar-and-piano performance with alternating passages, a
guitar-and-singing performance, a continuous acoustic-guitar performance, a
chainsaw demonstration, and a basketball game. Their full lengths are 120,
230, 101, 113, and 136 one-second segments; only the prior memory is limited to
10 seconds.
The page does not
