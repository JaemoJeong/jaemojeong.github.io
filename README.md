...
was not evaluated in the paper. It uses four longer LFAV test videos and lets
...
The replay supports only the four precomputed LFAV examples included in the
page data: a guitar-and-singing performance, a continuous acoustic-guitar
performance, a chainsaw demonstration, and a basketball game. Their full
lengths are 230, 101, 113, and 136 one-second segments; only the prior memory is
limited to 10 seconds. The page does not
